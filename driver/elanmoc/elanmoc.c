...
static const FpIdEntry id_table[] = {
  ...
  { .vid = 0x04f3, .pid = 0x0c88 },   /* add this */
 ...
 */
static void
elanmoc_enroll_collision_cb (FpiDeviceElanmoc *self,
                             uint8_t          *buffer_in,
                             gsize             length_in,
                             GError           *error)
{
...
static void
elanmoc_list_verify_cb (FpiDeviceElanmoc *self,
                        uint8_t          *buffer_in,
                        gsize             length_in,
                        GError           *error)
{
...
static void
elanmoc_get_finger_info_cb (FpiDeviceElanmoc *self,
                             uint8_t          *buffer_in,
                             gsize             length_in,
                             GError           *error)
{
