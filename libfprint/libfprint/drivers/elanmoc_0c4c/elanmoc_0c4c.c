...
static void elanmoc_cmd_ack_cb(FpiDeviceElanmoc0c4c *self, uint8_t *buffer_in,
...
static void enroll_status_report(FpiDeviceElanmoc0c4c *self,
...
static void elanmoc_get_enrolled_cb(FpiDeviceElanmoc0c4c *self,
                                    uint8_t *buffer_in, gsize length_in,
                                    GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
...
static void elanmoc_enroll_cb(FpiDeviceElanmoc0c4c *self, uint8_t *buffer_in,
                              gsize length_in, GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
    return;
...
static void elanmoc_enroll_collision_cb(FpiDeviceElanmoc0c4c *self,
                                        uint8_t *buffer_in, gsize length_in,
                                        GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
...
static void elanmoc_commit_cb(FpiDeviceElanmoc0c4c *self, uint8_t *buffer_in,
                              gsize length_in, GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
    return;
...
static void elanmoc_list_verify_cb(FpiDeviceElanmoc0c4c *self,
                                   uint8_t *buffer_in, gsize length_in,
                                   GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
...
static void elanmoc_get_finger_info_cb(FpiDeviceElanmoc0c4c *self,
                                       uint8_t *buffer_in, gsize length_in,
                                       GError *error) {
...
static void elanmoc_match_report_cb(FpiDeviceElanmoc0c4c *self,
                                    uint8_t *buffer_in, gsize length_in,
                                    GError *error) {
  FpDevice *device = FP_DEVICE(self);
  FpPrint *print = NULL;
...
static void identify_status_report(FpiDeviceElanmoc0c4c *self,
...
static void elanmoc_identify_cb(FpiDeviceElanmoc0c4c *self, uint8_t *buffer_in,
                                gsize length_in, GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
    return;
...
static void elanmoc_delete_cb(FpiDeviceElanmoc0c4c *self, uint8_t *buffer_in,
                              gsize length_in, GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
    return;
...
static void elanmoc_clear_storage_cb(FpiDeviceElanmoc0c4c *self,
                                     uint8_t *buffer_in, gsize length_in,
                                     GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
...
static void task_ssm_clear_storage_done(FpiSsm *ssm, FpDevice *dev,
                                        GError *error) {
  FpiDeviceElanmoc0c4c *self = FPI_DEVICE_ELANMOC_0C4C(dev);
...
static void elan_clear_storage_run_state(FpiSsm *ssm, FpDevice *dev) {
  guint8 *cmd_buf = NULL;
...
static void elanmoc_clear_storage(FpDevice *device) {
  FpiDeviceElanmoc0c4c *self = FPI_DEVICE_ELANMOC_0C4C(device);
...
static void elanmoc_cmd_ver_cb(FpiDeviceElanmoc0c4c *self, uint8_t *buffer_in,
                               gsize length_in, GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
    return;
...
static void elanmoc_cmd_dim_cb(FpiDeviceElanmoc0c4c *self, uint8_t *buffer_in,
                               gsize length_in, GError *error) {
  if (error) {
    fpi_ssm_mark_failed(self->task_ssm, error);
    return;
...
static void elanmoc_get_status_cb(FpiDeviceElanmoc0c4c *self,
                                  uint8_t *buffer_in, gsize length_in,
                                  GError *error) {
  guint8 *cmd_buf = NULL;
...
static void fpi_device_elanmoc_0c4c_init(FpiDeviceElanmoc0c4c *self) {
  G_DEBUG_HERE();
}
